...
namespace App\Services\V1\Eleicao\VotosMunicipio2024RJ;

use App\Models\V1\Eleicao\VotosMunicipio2024RJ\SqlViewModel;
use App\Services\V1\BaseViewService;

/**
 * Service de leitura para o módulo VotosMunicipio2024RJ.
 *
