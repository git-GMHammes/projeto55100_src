...
namespace App\Controllers\Api\V1\User\UserUsers;

use App\Controllers\Api\V1\BaseResourceTableController;
use App\Requests\V1\User\UserUsers\CreateRequest;
use App\Requests\V1\User\UserUsers\UpdateRequest;
use App\Services\V1\User\UserUsers\Processor;
use CodeIgniter\HTTP\RequestInterface;
use CodeIgniter\HTTP\ResponseInterface;
use Psr\Log\LoggerInterface;

/**
 * Controller de recurso para operações diretas na tabela user_users.
 *
