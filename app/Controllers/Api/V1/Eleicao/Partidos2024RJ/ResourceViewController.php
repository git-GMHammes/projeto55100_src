...
namespace App\Controllers\Api\V1\Eleicao\Partidos2024RJ;

use App\Controllers\Api\V1\BaseResourceViewController;
use App\Services\V1\Eleicao\Partidos2024RJ\Processor;
use CodeIgniter\HTTP\RequestInterface;
use CodeIgniter\HTTP\ResponseInterface;
use Psr\Log\LoggerInterface;

/**
 * Controller de recurso para consultas na view view_partidos_2024_RJ.
 *
