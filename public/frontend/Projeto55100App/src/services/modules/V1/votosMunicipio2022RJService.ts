...
const BASE_VIEW = `${APP_BASE_HOST}/api/${v}/votos-municipio-2022-rj-view`

// ─── Tipo da View (view_votos_municipio_2022) ─────────────────────────────────

export interface VotosMunicipio2022RJView {
  ID: number
...
export async function getAllView(
  page = 1,
  limit = 50,
): Promise<ApiPageEnvelope<VotosMunicipio2022RJView[]>> {
